...
tokenise("JANUARI"++Rest, Acc)   -> tokenise(Rest, [1 | Acc]);
tokenise("JAN"++Rest, Acc)       -> tokenise(Rest, [1 | Acc]);
tokenise("FEBRUARY"++Rest, Acc)   -> tokenise(Rest, [2 | Acc]);
tokenise("FEBRUARI"++Rest, Acc)   -> tokenise(Rest, [2 | Acc]);
...
tokenise("MAART"++Rest, Acc)       -> tokenise(Rest, [3 | Acc]);
...
tokenise("MEI"++Rest, Acc)       -> tokenise(Rest, [5 | Acc]);
tokenise("JUNE"++Rest, Acc)      -> tokenise(Rest, [6 | Acc]);
tokenise("JUNI"++Rest, Acc)      -> tokenise(Rest, [6 | Acc]);
tokenise("JUN"++Rest, Acc)       -> tokenise(Rest, [6 | Acc]);
tokenise("JULY"++Rest, Acc)      -> tokenise(Rest, [7 | Acc]);
tokenise("JULI"++Rest, Acc)      -> tokenise(Rest, [7 | Acc]);
tokenise("JUL"++Rest, Acc)       -> tokenise(Rest, [7 | Acc]);
tokenise("AUGUSTUS"++Rest, Acc)    -> tokenise(Rest, [8 | Acc]);
...
tokenise("OKTOBER"++Rest, Acc)   -> tokenise(Rest, [10 | Acc]);
