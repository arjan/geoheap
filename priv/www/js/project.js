...
//this --> should probably go in a seperate file
...
//up until here this <-- probably should go in a seperate file
                    
    var styledMap = new google.maps.StyledMapType(styledMapStyleset, {name:"floriade_radar"});

    var myOptions = {
        center: new google.maps.LatLng(52.310550, 4.957151),
        zoom: 13,
        mapTypeControlOptions: {
            mapTypeIds: [google.maps.MapTypeID.ROADMAP, 'floriade_radar']
        }
    };
    var map = new google.maps.Map(document.getElementById("map"),
                                  myOptions);

    map.mapTypes.set('floriade_radar', styledMap);
    map.sertMapTypeId('floriade_radar');
